...
# eliminating the need to copy data. Tensors are also optimized for automatic differentiation.
...
# Try out some of the operations from the list. If you’re familiar with the NumPy API,
...
# If you have a one-element tensor, for example by aggregating all values of a tensor
